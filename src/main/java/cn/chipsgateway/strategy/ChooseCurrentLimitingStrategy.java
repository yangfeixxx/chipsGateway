...
public class ChooseCurrentLimitingStrategy implements ChooseStrategy<Boolean> {
    ...
    public ChooseCurrentLimitingStrategy(Map map, AbstractCurrentlimiter abstractCurrentlimiter) {
